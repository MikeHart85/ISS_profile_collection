...
from ophyd import ( Component as Cpt, ADComponent, Device, PseudoPositioner,
                    ...
                    OverlayPlugin, FilePlugin, Signal)
...
pil100k.tiff.read_path_template  = '/home/det/PilatusData/'
...
pil100kroi1 = EpicsSignal('XF:08IDB-ES{Det:PIL1}Stats1:Total_RBV', name='pil1ookroi1')
